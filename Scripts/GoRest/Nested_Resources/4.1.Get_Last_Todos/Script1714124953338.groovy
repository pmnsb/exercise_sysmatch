...
ResponseObject resposta = WS.sendRequest(findTestObject('Nested_Resources/Get_Last_Todos'))
...
def title = jsonResposta.title

// Assert para verificar se o 'body' na resposta corresponde à GlobalVariable 'body_Post'
assert title == GlobalVariable.title_Todos

println("Assert bem-sucedido para a GlobalVariable 'title_Todos'")
